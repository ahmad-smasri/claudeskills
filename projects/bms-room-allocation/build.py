...
from bfgf_extra_alloc import BFGF
...
FLOORS = list(GF) + list(BF) + list(F1) + list(F2) + list(F3) + list(F4) + list(F5) + list(F6) + list(F7) + list(F8) + list(F9) + list(F10) + list(F11) + list(RF) + list(BFGF)
