...
KEEP_CALCULATED = {
    ...
    # QNL-056: the virtual metering layer's 14 tokens, one pair per meter class.
    ...
    # by accident rather than by rule. Without this block a re-run deletes 2,906
    # points and 5,812 rows, which is the whole metering layer.
